	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="col-md-offset-4 col-md-4" id="box">
				<h2>Dang Ky</h2>
				<hr>
				<form class="form-horizontal" action="<%=request.getContextPath()%>/dangKy" method="post" id="login_form">
					<fieldset>
						...
						<div class="form-group">
							<div class="col-md-12">
								<button type="submit" class="btn btn-md btn-danger pull-right">Dang Ky</button>
							</div>
						</div>
					</fieldset>
